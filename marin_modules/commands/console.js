...
module.exports.handleEvent = async function ({ api, event, Threads }) {
  ...
  const gradientText = (text) => gradient('pink', 'yellow')(text);
  const boldText = (text) => chalk.bold(text);

  console.log(gradientText("━━━━━━━━━━[ KUGISAKI NOBARA ]━━━━━━━━━━"));
...
console.log(`${boldText(gradientText(`┣➤ BotPack Modified by FRANZ ANTHONY`))}`);
  console.log(gradientText("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛"));
};
